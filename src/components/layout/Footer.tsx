    ...
    <footer className="bg-navy-900 text-cream">
      ...
      <div className="container-luxury section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-display text-lg font-semibold mb-6 text-gold-400">
              Navigation
            </h3>
            <ul className="space-y-3">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-cream/60 hover:text-gold-400 transition-colors duration-300 text-sm"
                  >
                    {item.name}
                  </Link>
                </li>
        ...
        <div className="container-luxury py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-cream/40 text-sm">
              © {new Date().getFullYear()} HOREVA. Tous droits réservés.
            </p>
            <div className="flex gap-6">
              {navigation.legal.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-cream/40 hover:text-gold-400 transition-colors duration-300 text-xs"
                >
                  {item.name}
                </Link>
              ))}
