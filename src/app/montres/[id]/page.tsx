...
const watchesData: Record<string, {
  ...
  "rolex-gmt-master-ii-pepsi": {
    ...
    originalPrice: 13100,
    image: "/gmt.webp",
    images: ["/gmt.webp", "/gmt2.webp", "/gmt3.webp", "/gmt4.webp", "/gmt5.webp"],
    condition: "Excellent",
    year: 1980,
    category: "Sport",
    details: "Full set • 3 lunettes • Garantie 12 mois • Mouvement automatique",
    description: "La Rolex GMT Master II 16710, surnommée \"Pepsi\" pour son iconique lunette bicolore bleu et rouge, est une légende de l'horlogerie sportive. Ce millésime des années 80 équipé du mouvement automatique 3185 est l'une des références les plus prisées par les collectionneurs. Cette pièce exceptionnelle est livrée avec un set complet comprenant trois lunettes interchangeables : Pepsi, Coke et Black, offrant ainsi une polyvalence unique.",
    specifications: {
    ...
    included: [
      ...
      "Boîte Rolex d'origine",
      "Sur-boîte",
      "3 lunettes (Pepsi, Coke, Black)",
      "Manuel et documentation",
      "Garantie HOREVA 12 mois",
    ],
    highlights: [
      "Millésime années 80 très recherché",
      "3 lunettes interchangeables incluses",
      "Calibre manufacture Rolex 3185",
      "Full set complet avec sur-boîte",
      "Icône de l'horlogerie sportive",
    ],
  },
  "rolex-submariner-kermit-first-owner": {
    id: "rolex-submariner-kermit-first-owner",
    brand: "ROLEX",
    model: "Submariner « Kermit »",
    reference: "16610LV",
    price: 13500,
    image: "/roro.webp",
    images: ["/roro.webp", "/roro2.webp", "/roro3.webp", "/roro5.webp", "/roro6.webp", "/roro7.webp"],
    condition: "Excellent",
    year: 2007,
    category: "Sport",
    details: "Full set • Première main • Garantie 12 mois • Mouvement automatique",
    description: "Une opportunité exceptionnelle d'acquérir une Rolex Submariner 16610LV \"Kermit\" de première main. Ce millésime 2007, conservé dans un état excellent par son unique propriétaire, représente l'un des modèles les plus emblématiques de la collection Submariner. La lunette verte caractéristique et le cadran noir créent un contraste saisissant qui fait de cette montre une pièce de collection très recherchée. Livrée avec son full set complet, cette pièce est une acquisition rare sur le marché secondaire.",
    specifications: {
      movement: "Automatique Rolex Calibre 3135",
      case: "Acier Oystersteel 904L",
      dial: "Cadran noir avec index luminescents",
    ...
    included: [
      ...
      "Garantie HOREVA 12 mois",
      "Facture d'achat originale (première main)",
    ],
    highlights: [
      "Première main avec historique complet",
      "Millésime 2007 très recherché",
      "Lunette verte \"Kermit\" iconique",
      "Calibre manufacture Rolex 3135",
      "Full set complet authentique",
  ...
  "longines-vintage": {
    ...
    reference: "Millésime 60's",
    price: 540,
    image: "/longinees.jpeg",
    condition: "Bon",
    year: 1960,
    category: "Classique",
    details: "Garantie 12 mois • Mouvement automatique",
    description: "Cette Longines vintage des années 60 représente l'essence de l'horlogerie suisse traditionnelle. Longines, manufacture fondée en 1832, est reconnue mondialement pour la qualité et la fiabilité de ses montres. Cette pièce vintage en bon état est équipée d'un mouvement automatique robuste et affiche un design classique intemporel. Avec son prix très accessible, cette Longines est une excellente porte d'entrée dans le monde de l'horlogerie vintage suisse de qualité.",
    specifications: {
      movement: "Automatique Longines",
      case: "Acier inoxydable",
      dial: "Cadran argenté avec index",
      bracelet: "Bracelet cuir",
      waterResistance: "30 mètres",
      diameter: "34 mm",
    },
    ...
    highlights: [
      "Authentique millésime années 60",
      "Manufacture suisse Longines (fondée en 1832)",
      "Mouvement automatique robuste",
      "Design classique intemporel",
      "Prix très accessible pour du vintage suisse",
  ...
  "rado-golden-horse": {
    id: "rado-golden-horse",
    brand: "RADO",
    model: "Golden Horse",
    reference: "Millésime 80's",
    price: 940,
    image: "/horse.jpeg",
    condition: "Très bon",
    year: 1980,
    category: "Classique",
    details: "Garantie 12 mois • Mouvement automatique 93 jewels",
    description: "La Rado Golden Horse est une légende de l'horlogerie vintage des années 80. Son nom évoque la robustesse et la fiabilité qui ont fait la réputation de Rado. Cette pièce exceptionnelle est équipée d'un mouvement automatique à 93 rubis (jewels), témoignant de la haute qualité de fabrication et de la précision recherchée. En très bon état de conservation, cette Golden Horse incarne le charme des montres sportives-élégantes vintage, avec un design intemporel qui traverse les décennies.",
    specifications: {
      movement: "Automatique Rado 93 rubis (jewels)",
      case: "Acier inoxydable",
      dial: "Cadran avec index appliqués",
      bracelet: "Bracelet acier intégré",
      waterResistance: "50 mètres",
      diameter: "37 mm",
    },
    included: [
    ...
    highlights: [
      "Légendaire modèle Golden Horse",
      "Mouvement automatique haute qualité 93 rubis",
      "Millésime années 80 authentique",
      "État de conservation très bon",
      "Design sportif-élégant intemporel",
      "Manufacture suisse Rado",
    ],
  },
  ...
  "omega-seamaster-120-baby-proplof-2": {
    ...
    description: "Cette Omega Seamaster 120, affectueusement surnommée 'Baby Proplof' par les collectionneurs, est une icône des montres de plongée vintage des années 70. Équipée du robuste mouvement automatique calibre 1010, cette pièce de 39mm incarne le design distinctif et l'ingénierie innovante d'Omega. Avec son boîtier en acier et son esthétique unique inspirée de la légendaire Ploprof, cette Seamaster 120 en très bon état est actuellement proposée en promotion. Une opportunité exceptionnelle d'acquérir une montre de plongée historique très recherchée.",
    specifications: {
      movement: "Automatique Omega Calibre 1010",
      case: "Acier inoxydable",
      dial: "Cadran avec index luminescents",
      bracelet: "Bracelet acier",
      waterResistance: "120 mètres",
    ...
    highlights: [
      "Légendaire 'Baby Proplof'",
      "Calibre automatique 1010 robuste",
      "Authentique millésime années 70",
      "Design iconique de plongée",
  ...
  "tudor-ranger-ii-prince-oysterdate-2": {
    ...
    category: "Sport",
    details: "Garantie 12 mois • Mouvement automatique",
    description: "La Tudor Ranger II Prince Oysterdate des années 70 est une pièce sportive emblématique de la collection Tudor. Cette version de 38mm équipée du légendaire boîtier Oyster et d'un mouvement automatique robuste incarne la robustesse et la fiabilité qui ont fait la réputation de Tudor. Son design sport-élégant avec fonction date en fait une montre polyvalente parfaite pour tous les jours. En très bon état de conservation, cette Ranger II représente une excellente opportunité d'acquérir une montre de qualité manufacture à un excellent rapport qualité-prix.",
    specifications: {
      movement: "Automatique Tudor",
      case: "Acier inoxydable Oyster",
      dial: "Cadran avec index appliqués et date",
    ...
    highlights: [
      "Authentique millésime années 70",
      "Collection Ranger II iconique",
      "Boîtier Oyster légendaire 38mm",
      "Mouvement automatique robuste",
      "Fonction date pratique",
      "État de conservation très bon",
    ],
  },
  "tudor-oyster-elegante-2": {
    id: "tudor-oyster-elegante-2",
    brand: "TUDOR",
    model: "Oyster « Élégante » par Rolex",
    reference: "Millésime 70's",
    price: 1400,
    image: "/nono3.webp",
    condition: "Très bon",
    ...
    category: "Classique",
    details: "Garantie 12 mois • Mouvement remontage manuel",
    description: "La Tudor Oyster « Élégante » des années 70, portant la signature 'par Rolex', incarne l'élégance discrète et le savoir-faire horloger de la marque sœur de Rolex. Cette pièce vintage à remontage manuel de 34mm en très bon état combine le charme authentique de l'horlogerie mécanique traditionnelle avec la robustesse légendaire du boîtier Oyster. Avec son design classique intemporel et son mouvement manuel qui crée un lien unique avec son porteur, cette Tudor représente une opportunité d'acquérir une pièce de qualité avec l'héritage Rolex à un prix accessible.",
    specifications: {
      movement: "Remontage manuel Tudor",
      case: "Acier inoxydable Oyster",
      dial: "Cadran avec index appliqués",
  ...
  "tudor-prince-oysterdate-31": {
    id: "tudor-prince-oysterdate-31",
    brand: "TUDOR",
    model: "Prince Oysterdate 31 Bi-Color",
    ...
    year: 1950,
    category: "Classique",
    details: "Garantie 12 mois • Mouvement remontage manuel • Bi-color",
    description: "La Tudor Prince Oysterdate 31 bi-color des années 50 est une pièce vintage exceptionnelle qui incarne l'élégance classique de l'horlogerie de cette époque dorée. Ce modèle de 31mm à remontage manuel en très bon état arbore un design bi-color distinctive combinant l'acier et l'or. Avec son boîtier Oyster légendaire et sa fonction date, cette Prince représente une opportunité rare d'acquérir une montre Tudor historique des années 50 avec le charme authentique de l'horlogerie mécanique d'époque.",
    specifications: {
      movement: "Remontage manuel Tudor",
      case: "Acier et or (bi-color) Oyster",
      dial: "Cadran avec index appliqués et date",
      bracelet: "Bracelet cuir",
      waterResistance: "30 mètres",
      diameter: "31 mm",
    ...
    highlights: [
      ...
      "Design bi-color élégant",
      "Boîtier Oyster Prince",
      "Mouvement remontage manuel",
      "Fonction date pratique",
      "Pièce historique recherchée",
    ],
  },
  "heuer-daytona-chronomatic": {
    id: "heuer-daytona-chronomatic",
    brand: "HEUER",
    model: "Daytona Chronomatic",
    reference: "Millésime 70's",
    price: 3800,
    image: "/nono5.webp",
    condition: "Très bon",
    year: 1970,
    category: "Sport",
    details: "Garantie 12 mois • Mouvement remontage manuel calibre 12",
    description: "La Heuer Daytona Chronomatic des années 70 est une légende de l'horlogerie sportive et du chronographe vintage. Équipée du célèbre mouvement remontage manuel calibre 12, cette pièce de 39mm en très bon état représente l'héritage racing de Heuer avant la fusion avec TAG en 1985. Avec son esthétique chronographe racing authentique et son boîtier en acier, cette Daytona Chronomatic est une pièce de collection exceptionnelle très recherchée par les amateurs de montres de sport automobile vintage.",
    specifications: {
      movement: "Remontage manuel Calibre 12",
      case: "Acier inoxydable",
      dial: "Cadran avec compteurs de chronographe",
      bracelet: "Bracelet acier",
      waterResistance: "50 mètres",
    ...
    highlights: [
      "Authentique millésime années 70",
      "Légendaire calibre 12",
      "Heuer avant TAG (pré-1985)",
      "Chronographe racing iconique",
      "État de conservation très bon",
      "Pièce de collection recherchée",
    ],
  },
  "girard-perregaux-monte-carlo-historique": {
    id: "girard-perregaux-monte-carlo-historique",
    brand: "GIRARD-PERREGAUX",
    model: "Rallye Monte-Carlo Historique 1965",
    reference: "Édition limitée 250 ex.",
    price: 2900,
    image: "/nono6.webp",
    condition: "Excellent",
    year: 2011,
    category: "Classique",
    details: "Garantie 12 mois • Mouvement automatique manufacture",
    description: "La Girard-Perregaux Rallye Monte-Carlo Historique 1965 est une édition limitée à 250 exemplaires dans le monde, célébrant l'histoire automobile légendaire du rallye de Monte-Carlo. Ce millésime 2011 en excellent état est équipé d'un mouvement automatique manufacture Girard-Perregaux. Son design classique inspiré des années 65 avec des touches sportives en fait une montre polyvalente et élégante. Cette édition limitée représente un investissement horloger de qualité pour les amateurs d'histoire automobile et d'horlogerie de manufacture.",
    specifications: {
      movement: "Automatique manufacture Girard-Perregaux",
      case: "Acier inoxydable poli/satiné",
      dial: "Cadran inspiré rallye avec index appliqués",
      bracelet: "Bracelet cuir avec boucle déployante",
      waterResistance: "50 mètres",
      diameter: "40 mm",
    },
    ...
    highlights: [
      "Édition limitée 250 exemplaires monde",
      "Hommage rallye Monte-Carlo historique",
      "Mouvement manufacture suisse",
      "Millésime 2011 moderne",
      "État de conservation excellent",
      "Investissement horloger de qualité",
    ],
  },
  "longines-chronographe-13zn-flyback": {
    id: "longines-chronographe-13zn-flyback",
    brand: "LONGINES",
    model: "Chronographe 13ZN Flyback",
    reference: "Millésime 1946",
    price: 4150,
    originalPrice: 4900,
    image: "/nono7.webp",
    ...
    year: 1946,
    category: "Classique",
    details: "Extrait d'archives • Garantie 12 mois • Mouvement 13ZN • Flyback",
    description: "Cette Longines Chronographe équipée du légendaire calibre 13ZN avec fonction flyback de 1946 est une pièce historique d'exception. Le calibre 13ZN est l'un des mouvements de chronographe les plus recherchés et respectés de l'histoire horlogère. La fonction flyback permet de réinitialiser et redémarrer le chronographe d'une seule pression, une complication rare et prisée. Livré avec son extrait d'archives officiel Longines confirmant son authenticité, ce chronographe vintage de 38mm en très bon état est actuellement en promotion. Un investissement horloger de collection exceptionnel.",
    specifications: {
      movement: "Remontage manuel Longines Calibre 13ZN",
      case: "Acier inoxydable",
      dial: "Cadran avec compteurs de chronographe",
    ...
    highlights: [
      "Millésime 1946 authentique",
      "Légendaire calibre 13ZN avec flyback",
      "Extrait d'archives officiel inclus",
      "Fonction flyback rare",
      "Prix promotionnel exceptionnel",
      "Pièce d'histoire horlogère",
    ],
  },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div>
                  <span className="font-display text-display-sm font-semibold text-red-600">
